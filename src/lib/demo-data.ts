...
export const leads = [
  { id: "LD-2084", customer: "Maya Robinson", business: "Halo Beauty Studio", source: "Meta Ads", agent: "Uzma Khan", callback: "Today, 9:30 AM", stage: "Follow-up", value: "$4,500" },
  { id: "LD-2078", customer: "Daniel Scott", business: "DS Roofing", source: "Cold Calling", agent: "Haroon Ali", callback: "Today, 11:00 AM", stage: "Approved", value: "$8,200" },
  { id: "LD-2069", customer: "Olivia Bennett", business: "Bennett Realty", source: "Referral", agent: "Rohan Malik", callback: "Today, 1:15 PM", stage: "Submitted", value: "$3,800" },
  { id: "LD-2061", customer: "Ava Williams", business: "Luxe Locs", source: "Google / SEO", agent: "Uzma Khan", callback: "Yesterday", stage: "In Progress", value: "$6,100" },
  { id: "LD-2057", customer: "Noah Carter", business: "Carter Contracting", source: "LinkedIn", agent: "Haroon Ali", callback: "Jun 23", stage: "Closed Won", value: "$12,400" },
  { id: "LD-2048", customer: "Emma Parker", business: "Parker Dental", source: "Cold Calling", agent: "Rohan Malik", callback: "Jun 25", stage: "New", value: "$5,750" },
];
