...
const updateSchema = z.object({ customerName: z.string().optional(), businessName: z.string().optional(), phoneNumber: z.string().optional(), email: z.string().optional(), reachBackDate: z.coerce.date().optional(), notes: z.string().optional(), assignedAgent: z.string().optional(), status: z.string().optional() });
